...
template <> constexpr inline auto LoginWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QString &, UserRole)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loginSuccessful((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<UserRole>>(_a[2]))); break;
        case 1: _t->onLoginClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWindow::*)(const QString & , UserRole )>(_a, &LoginWindow::loginSuccessful, 0))
            return;
    }
}
...
// SIGNAL 0
void LoginWindow::loginSuccessful(const QString & _t1, UserRole _t2)
{
